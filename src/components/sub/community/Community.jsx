	...
	return (
		<Layout title={'Community'}>
			...
			<div className="contextBox">
				<h1>"Thankyou, for text here"</h1>
				<span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sapiente quam doloremque quod obcaecati nam a mollitia porro, eveniet facere ipsam veniam voluptatibus sint repellat asperiores molestias laudantium, laboriosam quaerat. Et pariatur atque possimus quae cupiditate magnam placeat suscipit ducimus molestiae!</span>
			</div>
...
/*
	아직 데이터베이스를 배우진 않았지만 CRUD기능을 구현하고 싶어서 로컬저장소를 활용해서 만들어 봤다.

	이슈사항
	- 이슈사항으로는 시간값을 가져왔는데 로컬저장소에 글이 저장되는 시점을 표준시로 저장을 해서 현재시간보다 9시간이 늦은 시간으로 출력 되는 문제가 있었다.
	...
	두번째 이슈사항
	- 친구컴퓨터로 내 작업물을 확인해보니 해당 브라우저에는 저장된 데이터가 없어서 커뮤니티 페이지가 빈화면으로 출력되는 이슈가 있었다.
	- 로컬저장소에 값이 없을떄 더미 데이터가 출력되도록 했다.
*/
